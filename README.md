...
| app-configmap.yaml     | create redis pod with configmap | ConfigMap - store non-confidential data in key-value pairs | [app-configmap.yaml](./yaml/app-configmap.yaml) |
...
| app-volumeMounts.yaml  | add volume to a pod |  |  [app-volumeMounts.yaml](./yaml/app-volumeMounts.yaml)|
